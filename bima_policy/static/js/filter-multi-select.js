(function ($) {
      ...
      function () {
        ...
        class_3.prototype.initialize = function () {
          ...
          this.checkbox.addEventListener('change', function (e) {
			...
			if(_this.fms.name=="rtostates[]"){
				getRTOs();
			}
			if(_this.fms.name=="vehicle_makeby[]"){
				getModels();
			}
    ...
    $__default['default'].fn.filterMultiSelect = function (args) {
      ...
      if (typeof args.placeholderText === 'undefined') args.placeholderText = 'select';
      if (typeof args.filterText === 'undefined') args.filterText = 'Search';
